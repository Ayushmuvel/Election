...
contract Election {
      ...
      uint public voting_count = 1;
      uint public candidate_count = 0;
      uint public voter_count =0;
      bool public _selected_candidate_status;
      bool public _candidate_status = false;
      ...
      function start_voting (bool _status) payable public{
          require( msg.sender == chairperson, ' you are not authorized Persons' );
          require(voting != _status,'status all ready chagerd');
          require(voting_count == 1,'voting process can be started only one time');
